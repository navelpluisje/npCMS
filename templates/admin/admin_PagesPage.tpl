<div id="content" class="news">
	...
	<div class="buttons top"><a href="/admin/pages/new" class="add" title="Voeg item toe"></a></div>
	<div class="items">
		{section name="i" loop=$pageItems}
		<div class="item {cycle values='odd,even'}">
			<div class="buttons">
				<a href="/admin/pages/delete/{$pageItems[i].id}" class="remove right" title="Verwijder item"></a>
				<a href="/admin/pages/edit/{$pageItems[i].id}" class="edit left" title="Wijzig item"></a>
			</div>
			<h3><a href="/admin/pages/edit/{$pageItems[i].id}">{$pageItems[i].page_title}</a></h3>
